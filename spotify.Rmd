...
author: "[curso-r](https://curso-r.com/)"
date: "3/23/2022"
...
Entretanto, esse comportamento aparentemente é causado pelo percentual de múscias na concentração inferior da distribuição de score de probabilidade , que identificamos  

Tendo verificado que múscias lançada em diferentes anos tem score de poplaridde bem distindtos vamos partir para análise de uma nova variável. Neste caso gênero muiscal. Na tabela abaixo podemos comparar 
